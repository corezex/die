...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "No. Results vary with health history, lifestyle, medications and consistency. We focus on realistic, sustainable habits rather than promising a specific outcome.",
    },
    {
      question:
