...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-green-800 via-green-700 to-emerald-700">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center gap-10 px-4 py-14 sm:px-6 md:py-20 lg:grid lg:grid-cols-[1.05fr_.95fr]">
        ...
        <div className="order-2 lg:order-1">
          <p className="inline-block max-w-full rounded-full bg-white/15 px-4 py-1.5 text-[11px] font-semibold uppercase leading-snug text-white ring-1 ring-white/25 backdrop-blur-sm sm:text-xs">
            <MapPin className="-mt-0.5 mr-1.5 inline-block h-3.5 w-3.5 align-middle text-green-100" aria-hidden="true" />
          ...
          <p className="mt-4 max-w-xl text-base leading-7 text-green-50/95 sm:text-lg">
          ...
          <ul className="mt-6 space-y-2.5">
            {[
              ...
              <li key={point} className="flex items-start gap-2.5">
                ...
                <span className="text-sm leading-6 text-green-50 sm:text-base">{point}</span>
              </li>
            ))}
          </ul>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <a
              href="/contact"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-7 py-3.5 font-semibold text-green-800 shadow-lg transition hover:bg-green-50 hover:shadow-xl"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-white/10 px-7 py-3.5 font-semibold text-white ring-1 ring-white/30 backdrop-blur-sm transition hover:bg-white/20"
            >
              <MessageCircle className="h-5 w-5 text-green-200" aria-hidden="true" />
              Chat on WhatsApp
            </a>
          </div>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-x-5 gap-y-2 border-t border-white/15 pt-5">
            ...
            <span className="text-sm text-green-50/90">MSc Dietetics · Certified Diabetic Educator</span>
            <span className="inline-flex items-center gap-1.5 text-sm text-green-50/80">
        ...
        <div className="relative order-1 mx-auto w-full max-w-[320px] sm:max-w-sm lg:order-2 lg:max-w-none">
          <div className="relative aspect-[7/9] overflow-hidden rounded-2xl shadow-2xl ring-1 ring-white/20">
            ...
            <span className="absolute bottom-3 left-3 inline-flex items-center gap-1.5 rounded-full bg-green-900/85 px-3 py-1 text-xs font-semibold text-white ring-1 ring-white/30 backdrop-blur-sm">
              <Award className="h-3.5 w-3.5 text-lime-200" aria-hidden="true" />
