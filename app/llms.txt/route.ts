...
const KEY_PAGES: Array<[string, string]> = [
  ...
  ["/services/condition-nutrition", "Condition-specific nutrition: PCOS, thyroid, diabetes, fatty liver, gut"],
  ["/services/pcos-nutrition", "PCOS nutrition support"],
  ["/services/thyroid-nutrition", "Thyroid nutrition support"],
  ["/services/diabetes-nutrition", "Diabetes nutrition support"],
  ["/services/fatty-liver-nutrition", "Fatty liver nutrition support"],
  ["/services/gut-health-nutrition", "Gut health & IBS nutrition support"],
  ["/services/kids-nutrition", "Kids & child nutrition support"],
  ["/services/corporate-wellness", "Corporate wellness programs"],
...
export function GET() {
  ...
  lines.push("");
  lines.push("DietFiniti provides personalised nutrition support for weight management, medical weight-loss, pregnancy, weight gain, sports nutrition and bridal goals, built around everyday Indian food. Nutrition guidance supports—it does not replace—medical care.");
  lines.push("");
  ...
  lines.push("");
  lines.push(`Full list of all 537 recipes is in [llms-full.txt](${siteUrl}/llms-full.txt).`);
  lines.push("");
