...
const disclaimerSchema = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": `${siteUrl}/disclaimer#webpage`,
      name: "Health Disclaimer | DietFiniti",
      description: "Important health and medical information disclaimer for DietFiniti nutrition services.",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Health Disclaimer", item: `${siteUrl}/disclaimer` }
      ]
    }
  ]
};
...
export default function DisclaimerPage() {
  return (
    <>
      ...
      />
      <article className="mx-auto max-w-4xl px-5 py-16 text-gray-800">
