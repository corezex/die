    ...
    <main className="bg-white px-4 py-24">
      <div className="mx-auto max-w-xl text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Link href="/" className="rounded-lg bg-teal-700 px-6 py-3 font-semibold text-white transition hover:bg-teal-800">
            Go to homepage
          </Link>
          <Link href="/recipe" className="rounded-lg border border-teal-700 px-6 py-3 font-semibold text-teal-800 transition hover:bg-teal-50">
            Browse recipes
          </Link>
          <Link href="/blog" className="rounded-lg border border-teal-700 px-6 py-3 font-semibold text-teal-800 transition hover:bg-teal-50">
            Read the blog
          </Link>
        </div>
      </div>
