  ...
  return (
    <>
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden pt-20 pb-10">
        ...
        <div className="absolute top-40 right-20 w-32 h-32 bg-green-300/20 rounded-full blur-xl"></div>
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Client <span className="bg-gradient-to-r from-green-600 to-green-600 bg-clip-text text-transparent">Experiences</span>
            </motion.h1>
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        {showApiLoading ? (
          ...
          <>
                  ...
                  <div className="p-4 sm:p-6 flex flex-col flex-grow">
                    <div className="flex items-start space-x-3 sm:space-x-4 mb-4">
                      <div className="flex-shrink-0">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-green-500 to-green-500 rounded-full flex items-center justify-center">
            ...
            {visibleCount < testimonials.length && (
              ...
              >
                <button
                  onClick={loadMore}
                  className="px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-green-500 to-green-500 text-white font-medium rounded-full text-sm sm:text-base hover:from-green-600 hover:to-green-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
          ...
          !error && (
            <div className="text-center py-8 bg-white rounded-2xl shadow-lg mb-8">
              <p className="text-gray-600 text-lg mb-6">No client stories available right now.</p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto px-4">
                {[
                  { name: "Priya M.", service: "Weight Loss", text: "After years of trying generic diets, the personalised approach finally made sense. My energy stayed stable and the WhatsApp support kept me consistent." },
                  { name: "Rahul K.", service: "Medical Weight Loss", text: "Working with my doctor and Dietitian Tejal together made food planning clear. I understood what to eat and why, without confusion." },
                  { name: "Anjali S.", service: "Bridal Diet", text: "The 3-month timeline fit my wedding prep perfectly. Simple Indian meals, no exotic ingredients, and visible results without stress." },
                ].map((t) => (
                  <div key={t.name} className="bg-gradient-to-br from-green-50 to-green-50 rounded-2xl border border-green-100 p-6 text-left shadow-sm">
                    <h4 className="font-bold text-slate-900">{t.name} · {t.service}</h4>
                    <p className="text-sm text-slate-700 mt-3 leading-relaxed">{t.text}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-8 sm:px-10 py-3 sm:py-4 bg-gradient-to-r from-green-600 to-green-600 text-white font-bold rounded-full text-base sm:text-lg hover:from-green-700 hover:to-green-700 transition-all duration-300 shadow-2xl"
          >
