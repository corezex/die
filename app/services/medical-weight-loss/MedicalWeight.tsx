...
export default function MedicalWeightLossProgram() {
  return <div className="service-page">
    ...
    <section className="bg-[#262262] px-4 py-16 text-white md:py-24"><div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.15fr_.85fr] lg:items-center"><div><p className="mb-4 font-semibold uppercase tracking-[0.18em] text-green-100 text-sm">Mumbai, Thane & online across India</p><h1 className="text-4xl font-bold tracking-tight md:text-6xl">Weight-management nutrition support alongside medical care</h1><p className="mt-6 max-w-3xl text-lg leading-8 text-green-50 md:text-xl">If a health condition is part of your weight-management journey, you deserve nutrition guidance that respects your medical care. DietFiniti can help you discuss practical food routines while you continue to work with your doctor or treating clinical team.</p><div className="mt-9"><ServiceCtaButtons contactColorClass="text-green-800" /></div></div><aside className="rounded-2xl border border-white/20 bg-white/10 p-7 backdrop-blur-sm"><h2 className="text-2xl font-bold">Important to know</h2><ul className="mt-5 space-y-4 leading-7 text-green-50"><li>• This service is nutrition support, not medical diagnosis or treatment.</li><li>• Do not start, stop or alter medication without your treating clinician.</li><li>• Share relevant medical guidance so nutrition advice can be considered in context.</li><li>• For urgent symptoms or emergencies, contact your doctor or emergency services.</li></ul></aside></div></section>
